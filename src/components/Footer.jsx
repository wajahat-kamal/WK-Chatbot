  ...
  return(
    <footer className="text-center text-[15px] font-semibold text-gray-900">
      ...
      <div className="flex flex-col md:flex-row md:gap-5 gap-0 md:mb-0 mb-3">
        <a href="https://wk-devportfolio.vercel.app/" className="hover:text-blue-900">Explore the <span className="text-blue-900">Portfolio</span> of the website's <span className="text-blue-900">Creator's</span> .</a>
        <a href="#" className="hover:text-blue-900">View the source code of this <span className="text-blue-900">Chatbot</span> website.</a>
        </div>
